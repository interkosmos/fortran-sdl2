...
! Licence: ISC
module sdl2_opengl
    use :: sdl2_c_types, only: c_double, c_float, c_int, c_long, c_ptr, c_short, c_signed_char 
    implicit none
    private
    ...
    ! Boolean values
    integer(kind=GLboolean), parameter, public :: GL_FALSE = 0
    integer(kind=GLboolean), parameter, public :: GL_TRUE  = 1

    ! Data types
    integer(kind=c_int), parameter, public :: GL_BYTE           = int(z'1400')
    integer(kind=c_int), parameter, public :: GL_UNSIGNED_BYTE  = int(z'1401')
    integer(kind=c_int), parameter, public :: GL_SHORT          = int(z'1402')
    integer(kind=c_int), parameter, public :: GL_UNSIGNED_SHORT = int(z'1403')
    integer(kind=c_int), parameter, public :: GL_INT            = int(z'1404')
    integer(kind=c_int), parameter, public :: GL_UNSIGNED_INT   = int(z'1405')
    integer(kind=c_int), parameter, public :: GL_FLOAT          = int(z'1406')
    integer(kind=c_int), parameter, public :: GL_2_BYTES        = int(z'1407')
    integer(kind=c_int), parameter, public :: GL_3_BYTES        = int(z'1408')
    integer(kind=c_int), parameter, public :: GL_4_BYTES        = int(z'1409')
    integer(kind=c_int), parameter, public :: GL_DOUBLE         = int(z'140A')

    ! OpenGL 1.2
    integer(kind=c_int), parameter, public :: GL_RESCALE_NORMAL                = int(z'803A')
    integer(kind=c_int), parameter, public :: GL_CLAMP_TO_EDGE                 = int(z'812F')
    integer(kind=c_int), parameter, public :: GL_MAX_ELEMENTS_VERTICES         = int(z'80E8')
    integer(kind=c_int), parameter, public :: GL_MAX_ELEMENTS_INDICES          = int(z'80E9')
    integer(kind=c_int), parameter, public :: GL_BGR                           = int(z'80E0')
    integer(kind=c_int), parameter, public :: GL_BGRA                          = int(z'80E1')
    integer(kind=c_int), parameter, public :: GL_UNSIGNED_BYTE_3_3_2           = int(z'8032')
    integer(kind=c_int), parameter, public :: GL_UNSIGNED_BYTE_2_3_3_REV       = int(z'8362')
    integer(kind=c_int), parameter, public :: GL_UNSIGNED_SHORT_5_6_5          = int(z'8363')
    integer(kind=c_int), parameter, public :: GL_UNSIGNED_SHORT_5_6_5_REV      = int(z'8364')
    integer(kind=c_int), parameter, public :: GL_UNSIGNED_SHORT_4_4_4_4        = int(z'8033')
    integer(kind=c_int), parameter, public :: GL_UNSIGNED_SHORT_4_4_4_4_REV    = int(z'8365')
    integer(kind=c_int), parameter, public :: GL_UNSIGNED_SHORT_5_5_5_1        = int(z'8034')
    integer(kind=c_int), parameter, public :: GL_UNSIGNED_SHORT_1_5_5_5_REV    = int(z'8366')
    integer(kind=c_int), parameter, public :: GL_UNSIGNED_INT_8_8_8_8          = int(z'8035')
    integer(kind=c_int), parameter, public :: GL_UNSIGNED_INT_8_8_8_8_REV      = int(z'8367')
    integer(kind=c_int), parameter, public :: GL_UNSIGNED_INT_10_10_10_2       = int(z'8036')
    integer(kind=c_int), parameter, public :: GL_UNSIGNED_INT_2_10_10_10_REV   = int(z'8368')
    integer(kind=c_int), parameter, public :: GL_LIGHT_MODEL_COLOR_CONTROL     = int(z'81F8')
    integer(kind=c_int), parameter, public :: GL_SINGLE_COLOR                  = int(z'81F9')
    integer(kind=c_int), parameter, public :: GL_SEPARATE_SPECULAR_COLOR       = int(z'81FA')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_MIN_LOD               = int(z'813A')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_MAX_LOD               = int(z'813B')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_BASE_LEVEL            = int(z'813C')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_MAX_LEVEL             = int(z'813D')
    integer(kind=c_int), parameter, public :: GL_SMOOTH_POINT_SIZE_RANGE       = int(z'0B12')
    integer(kind=c_int), parameter, public :: GL_SMOOTH_POINT_SIZE_GRANULARITY = int(z'0B13')
    integer(kind=c_int), parameter, public :: GL_SMOOTH_LINE_WIDTH_RANGE       = int(z'0B22')
    integer(kind=c_int), parameter, public :: GL_SMOOTH_LINE_WIDTH_GRANULARITY = int(z'0B23')
    integer(kind=c_int), parameter, public :: GL_ALIASED_POINT_SIZE_RANGE      = int(z'846D')
    integer(kind=c_int), parameter, public :: GL_ALIASED_LINE_WIDTH_RANGE      = int(z'846E')
    integer(kind=c_int), parameter, public :: GL_PACK_SKIP_IMAGES              = int(z'806B')
    integer(kind=c_int), parameter, public :: GL_PACK_IMAGE_HEIGHT             = int(z'806C')
    integer(kind=c_int), parameter, public :: GL_UNPACK_SKIP_IMAGES            = int(z'806D')
    integer(kind=c_int), parameter, public :: GL_UNPACK_IMAGE_HEIGHT           = int(z'806E')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_3D                    = int(z'806F')
    integer(kind=c_int), parameter, public :: GL_PROXY_TEXTURE_3D              = int(z'8070')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_DEPTH                 = int(z'8071')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_WRAP_R                = int(z'8072')
    integer(kind=c_int), parameter, public :: GL_MAX_3D_TEXTURE_SIZE           = int(z'8073')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_BINDING_3D            = int(z'806A')

    ! Primitives
    integer(kind=c_int), parameter, public :: GL_POINTS         = int(z'0000')
    integer(kind=c_int), parameter, public :: GL_LINES          = int(z'0001')
    integer(kind=c_int), parameter, public :: GL_LINE_LOOP      = int(z'0002')
    integer(kind=c_int), parameter, public :: GL_LINE_STRIP     = int(z'0003')
    integer(kind=c_int), parameter, public :: GL_TRIANGLES      = int(z'0004')
    integer(kind=c_int), parameter, public :: GL_TRIANGLE_STRIP = int(z'0005')
    integer(kind=c_int), parameter, public :: GL_TRIANGLE_FAN   = int(z'0006')
    integer(kind=c_int), parameter, public :: GL_QUADS          = int(z'0007')
    integer(kind=c_int), parameter, public :: GL_QUAD_STRIP     = int(z'0008')
    integer(kind=c_int), parameter, public :: GL_POLYGON        = int(z'0009')

    ! Vertex Arrays
    integer(kind=c_int), parameter, public :: GL_VERTEX_ARRAY                = int(z'8074')
    integer(kind=c_int), parameter, public :: GL_NORMAL_ARRAY                = int(z'8075')
    integer(kind=c_int), parameter, public :: GL_COLOR_ARRAY                 = int(z'8076')
    integer(kind=c_int), parameter, public :: GL_INDEX_ARRAY                 = int(z'8077')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_COORD_ARRAY         = int(z'8078')
    integer(kind=c_int), parameter, public :: GL_EDGE_FLAG_ARRAY             = int(z'8079')
    integer(kind=c_int), parameter, public :: GL_VERTEX_ARRAY_SIZE           = int(z'807A')
    integer(kind=c_int), parameter, public :: GL_VERTEX_ARRAY_TYPE           = int(z'807B')
    integer(kind=c_int), parameter, public :: GL_VERTEX_ARRAY_STRIDE         = int(z'807C')
    integer(kind=c_int), parameter, public :: GL_NORMAL_ARRAY_TYPE           = int(z'807E')
    integer(kind=c_int), parameter, public :: GL_NORMAL_ARRAY_STRIDE         = int(z'807F')
    integer(kind=c_int), parameter, public :: GL_COLOR_ARRAY_SIZE            = int(z'8081')
    integer(kind=c_int), parameter, public :: GL_COLOR_ARRAY_TYPE            = int(z'8082')
    integer(kind=c_int), parameter, public :: GL_COLOR_ARRAY_STRIDE          = int(z'8083')
    integer(kind=c_int), parameter, public :: GL_INDEX_ARRAY_TYPE            = int(z'8085')
    integer(kind=c_int), parameter, public :: GL_INDEX_ARRAY_STRIDE          = int(z'8086')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_COORD_ARRAY_SIZE    = int(z'8088')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_COORD_ARRAY_TYPE    = int(z'8089')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_COORD_ARRAY_STRIDE  = int(z'808A')
    integer(kind=c_int), parameter, public :: GL_EDGE_FLAG_ARRAY_STRIDE      = int(z'808C')
    integer(kind=c_int), parameter, public :: GL_VERTEX_ARRAY_POINTER        = int(z'808E')
    integer(kind=c_int), parameter, public :: GL_NORMAL_ARRAY_POINTER        = int(z'808F')
    integer(kind=c_int), parameter, public :: GL_COLOR_ARRAY_POINTER         = int(z'8090')
    integer(kind=c_int), parameter, public :: GL_INDEX_ARRAY_POINTER         = int(z'8091')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_COORD_ARRAY_POINTER = int(z'8092')
    integer(kind=c_int), parameter, public :: GL_EDGE_FLAG_ARRAY_POINTER     = int(z'8093')
    integer(kind=c_int), parameter, public :: GL_V2F                         = int(z'2A20')
    integer(kind=c_int), parameter, public :: GL_V3F                         = int(z'2A21')
    integer(kind=c_int), parameter, public :: GL_C4UB_V2F                    = int(z'2A22')
    integer(kind=c_int), parameter, public :: GL_C4UB_V3F                    = int(z'2A23')
    integer(kind=c_int), parameter, public :: GL_C3F_V3F                     = int(z'2A24')
    integer(kind=c_int), parameter, public :: GL_N3F_V3F                     = int(z'2A25')
    integer(kind=c_int), parameter, public :: GL_C4F_N3F_V3F                 = int(z'2A26')
    integer(kind=c_int), parameter, public :: GL_T2F_V3F                     = int(z'2A27')
    integer(kind=c_int), parameter, public :: GL_T4F_V4F                     = int(z'2A28')
    integer(kind=c_int), parameter, public :: GL_T2F_C4UB_V3F                = int(z'2A29')
    integer(kind=c_int), parameter, public :: GL_T2F_C3F_V3F                 = int(z'2A2A')
    integer(kind=c_int), parameter, public :: GL_T2F_N3F_V3F                 = int(z'2A2B')
    integer(kind=c_int), parameter, public :: GL_T2F_C4F_N3F_V3F             = int(z'2A2C')
    integer(kind=c_int), parameter, public :: GL_T4F_C4F_N3F_V4F             = int(z'2A2D')

    ! Matrix Mode
    integer(kind=c_int), parameter, public :: GL_MATRIX_MODE = int(z'0BA0')
    integer(kind=c_int), parameter, public :: GL_MODELVIEW   = int(z'1700')
    integer(kind=c_int), parameter, public :: GL_PROJECTION  = int(z'1701')
    integer(kind=c_int), parameter, public :: GL_TEXTURE     = int(z'1702')

    ! Points
    integer(kind=c_int), parameter, public :: GL_POINT_SMOOTH           = int(z'0B10')
    integer(kind=c_int), parameter, public :: GL_POINT_SIZE             = int(z'0B11')
    integer(kind=c_int), parameter, public :: GL_POINT_SIZE_GRANULARITY = int(z'0B13')
    integer(kind=c_int), parameter, public :: GL_POINT_SIZE_RANGE       = int(z'0B12')

    ! Lines
    integer(kind=c_int), parameter, public :: GL_LINE_SMOOTH            = int(z'0B20')
    integer(kind=c_int), parameter, public :: GL_LINE_STIPPLE           = int(z'0B24')
    integer(kind=c_int), parameter, public :: GL_LINE_STIPPLE_PATTERN   = int(z'0B25')
    integer(kind=c_int), parameter, public :: GL_LINE_STIPPLE_REPEAT    = int(z'0B26')
    integer(kind=c_int), parameter, public :: GL_LINE_WIDTH             = int(z'0B21')
    integer(kind=c_int), parameter, public :: GL_LINE_WIDTH_GRANULARITY = int(z'0B23')
    integer(kind=c_int), parameter, public :: GL_LINE_WIDTH_RANGE       = int(z'0B22')

    ! Polygons
    integer(kind=c_int), parameter, public :: GL_POINT                 = int(z'1B00')
    integer(kind=c_int), parameter, public :: GL_LINE                  = int(z'1B01')
    integer(kind=c_int), parameter, public :: GL_FILL                  = int(z'1B02')
    integer(kind=c_int), parameter, public :: GL_CW                    = int(z'0900')
    integer(kind=c_int), parameter, public :: GL_CCW                   = int(z'0901')
    integer(kind=c_int), parameter, public :: GL_FRONT                 = int(z'0404')
    integer(kind=c_int), parameter, public :: GL_BACK                  = int(z'0405')
    integer(kind=c_int), parameter, public :: GL_POLYGON_MODE          = int(z'0B40')
    integer(kind=c_int), parameter, public :: GL_POLYGON_SMOOTH        = int(z'0B41')
    integer(kind=c_int), parameter, public :: GL_POLYGON_STIPPLE       = int(z'0B42')
    integer(kind=c_int), parameter, public :: GL_EDGE_FLAG             = int(z'0B43')
    integer(kind=c_int), parameter, public :: GL_CULL_FACE             = int(z'0B44')
    integer(kind=c_int), parameter, public :: GL_CULL_FACE_MODE        = int(z'0B45')
    integer(kind=c_int), parameter, public :: GL_FRONT_FACE            = int(z'0B46')
    integer(kind=c_int), parameter, public :: GL_POLYGON_OFFSET_FACTOR = int(z'8038')
    integer(kind=c_int), parameter, public :: GL_POLYGON_OFFSET_UNITS  = int(z'2A00')
    integer(kind=c_int), parameter, public :: GL_POLYGON_OFFSET_POINT  = int(z'2A01')
    integer(kind=c_int), parameter, public :: GL_POLYGON_OFFSET_LINE   = int(z'2A02')
    integer(kind=c_int), parameter, public :: GL_POLYGON_OFFSET_FILL   = int(z'8037')

    ! Display Lists
    integer(kind=c_int), parameter, public :: GL_COMPILE             = int(z'1300')
    integer(kind=c_int), parameter, public :: GL_COMPILE_AND_EXECUTE = int(z'1301')
    integer(kind=c_int), parameter, public :: GL_LIST_BASE           = int(z'0B32')
    integer(kind=c_int), parameter, public :: GL_LIST_INDEX          = int(z'0B33')
    integer(kind=c_int), parameter, public :: GL_LIST_MODE           = int(z'0B30')

    ! Depth buffer
    integer(kind=c_int), parameter, public :: GL_NEVER             = int(z'0200')
    integer(kind=c_int), parameter, public :: GL_LESS              = int(z'0201')
    integer(kind=c_int), parameter, public :: GL_EQUAL             = int(z'0202')
    integer(kind=c_int), parameter, public :: GL_LEQUAL            = int(z'0203')
    integer(kind=c_int), parameter, public :: GL_GREATER           = int(z'0204')
    integer(kind=c_int), parameter, public :: GL_NOTEQUAL          = int(z'0205')
    integer(kind=c_int), parameter, public :: GL_GEQUAL            = int(z'0206')
    integer(kind=c_int), parameter, public :: GL_ALWAYS            = int(z'0207')
    integer(kind=c_int), parameter, public :: GL_DEPTH_TEST        = int(z'0B71')
    integer(kind=c_int), parameter, public :: GL_DEPTH_BITS        = int(z'0D56')
    integer(kind=c_int), parameter, public :: GL_DEPTH_CLEAR_VALUE = int(z'0B73')
    integer(kind=c_int), parameter, public :: GL_DEPTH_FUNC        = int(z'0B74')
    integer(kind=c_int), parameter, public :: GL_DEPTH_RANGE       = int(z'0B70')
    integer(kind=c_int), parameter, public :: GL_DEPTH_WRITEMASK   = int(z'0B72')
    integer(kind=c_int), parameter, public :: GL_DEPTH_COMPONENT   = int(z'1902')

    ! Lighting
    integer(kind=c_int), parameter, public :: GL_LIGHTING                 = int(z'0B50')
    integer(kind=c_int), parameter, public :: GL_LIGHT0                   = int(z'4000')
    integer(kind=c_int), parameter, public :: GL_LIGHT1                   = int(z'4001')
    integer(kind=c_int), parameter, public :: GL_LIGHT2                   = int(z'4002')
    integer(kind=c_int), parameter, public :: GL_LIGHT3                   = int(z'4003')
    integer(kind=c_int), parameter, public :: GL_LIGHT4                   = int(z'4004')
    integer(kind=c_int), parameter, public :: GL_LIGHT5                   = int(z'4005')
    integer(kind=c_int), parameter, public :: GL_LIGHT6                   = int(z'4006')
    integer(kind=c_int), parameter, public :: GL_LIGHT7                   = int(z'4007')
    integer(kind=c_int), parameter, public :: GL_SPOT_EXPONENT            = int(z'1205')
    integer(kind=c_int), parameter, public :: GL_SPOT_CUTOFF              = int(z'1206')
    integer(kind=c_int), parameter, public :: GL_CONSTANT_ATTENUATION     = int(z'1207')
    integer(kind=c_int), parameter, public :: GL_LINEAR_ATTENUATION       = int(z'1208')
    integer(kind=c_int), parameter, public :: GL_QUADRATIC_ATTENUATION    = int(z'1209')
    integer(kind=c_int), parameter, public :: GL_AMBIENT                  = int(z'1200')
    integer(kind=c_int), parameter, public :: GL_DIFFUSE                  = int(z'1201')
    integer(kind=c_int), parameter, public :: GL_SPECULAR                 = int(z'1202')
    integer(kind=c_int), parameter, public :: GL_SHININESS                = int(z'1601')
    integer(kind=c_int), parameter, public :: GL_EMISSION                 = int(z'1600')
    integer(kind=c_int), parameter, public :: GL_POSITION                 = int(z'1203')
    integer(kind=c_int), parameter, public :: GL_SPOT_DIRECTION           = int(z'1204')
    integer(kind=c_int), parameter, public :: GL_AMBIENT_AND_DIFFUSE      = int(z'1602')
    integer(kind=c_int), parameter, public :: GL_COLOR_INDEXES            = int(z'1603')
    integer(kind=c_int), parameter, public :: GL_LIGHT_MODEL_TWO_SIDE     = int(z'0B52')
    integer(kind=c_int), parameter, public :: GL_LIGHT_MODEL_LOCAL_VIEWER = int(z'0B51')
    integer(kind=c_int), parameter, public :: GL_LIGHT_MODEL_AMBIENT      = int(z'0B53')
    integer(kind=c_int), parameter, public :: GL_FRONT_AND_BACK           = int(z'0408')
    integer(kind=c_int), parameter, public :: GL_SHADE_MODEL              = int(z'0B54')
    integer(kind=c_int), parameter, public :: GL_FLAT                     = int(z'1D00')
    integer(kind=c_int), parameter, public :: GL_SMOOTH                   = int(z'1D01')
    integer(kind=c_int), parameter, public :: GL_COLOR_MATERIAL           = int(z'0B57')
    integer(kind=c_int), parameter, public :: GL_COLOR_MATERIAL_FACE      = int(z'0B55')
    integer(kind=c_int), parameter, public :: GL_COLOR_MATERIAL_PARAMETER = int(z'0B56')
    integer(kind=c_int), parameter, public :: GL_NORMALIZE                = int(z'0BA1')

    ! User clipping planes
    integer(kind=c_int), parameter, public :: GL_CLIP_PLANE0 = int(z'3000')
    integer(kind=c_int), parameter, public :: GL_CLIP_PLANE1 = int(z'3001')
    integer(kind=c_int), parameter, public :: GL_CLIP_PLANE2 = int(z'3002')
    integer(kind=c_int), parameter, public :: GL_CLIP_PLANE3 = int(z'3003')
    integer(kind=c_int), parameter, public :: GL_CLIP_PLANE4 = int(z'3004')
    integer(kind=c_int), parameter, public :: GL_CLIP_PLANE5 = int(z'3005')

    ! Accumulation buffer
    integer(kind=c_int), parameter, public :: GL_ACCUM_RED_BITS    = int(z'0D58')
    integer(kind=c_int), parameter, public :: GL_ACCUM_GREEN_BITS  = int(z'0D59')
    integer(kind=c_int), parameter, public :: GL_ACCUM_BLUE_BITS   = int(z'0D5A')
    integer(kind=c_int), parameter, public :: GL_ACCUM_ALPHA_BITS  = int(z'0D5B')
    integer(kind=c_int), parameter, public :: GL_ACCUM_CLEAR_VALUE = int(z'0B80')
    integer(kind=c_int), parameter, public :: GL_ACCUM             = int(z'0100')
    integer(kind=c_int), parameter, public :: GL_ADD               = int(z'0104')
    integer(kind=c_int), parameter, public :: GL_LOAD              = int(z'0101')
    integer(kind=c_int), parameter, public :: GL_MULT              = int(z'0103')
    integer(kind=c_int), parameter, public :: GL_RETURN            = int(z'0102')

    ! Alpha testing
    integer(kind=c_int), parameter, public :: GL_ALPHA_TEST      = int(z'0BC0')
    integer(kind=c_int), parameter, public :: GL_ALPHA_TEST_REF  = int(z'0BC2')
    integer(kind=c_int), parameter, public :: GL_ALPHA_TEST_FUNC = int(z'0BC1')

    ! Blending
    integer(kind=c_int), parameter, public :: GL_BLEND               = int(z'0BE2')
    integer(kind=c_int), parameter, public :: GL_BLEND_SRC           = int(z'0BE1')
    integer(kind=c_int), parameter, public :: GL_BLEND_DST           = int(z'0BE0')
    integer(kind=c_int), parameter, public :: GL_ZERO                = 0
    integer(kind=c_int), parameter, public :: GL_ONE                 = 1
    integer(kind=c_int), parameter, public :: GL_SRC_COLOR           = int(z'0300')
    integer(kind=c_int), parameter, public :: GL_ONE_MINUS_SRC_COLOR = int(z'0301')
    integer(kind=c_int), parameter, public :: GL_SRC_ALPHA           = int(z'0302')
    integer(kind=c_int), parameter, public :: GL_ONE_MINUS_SRC_ALPHA = int(z'0303')
    integer(kind=c_int), parameter, public :: GL_DST_ALPHA           = int(z'0304')
    integer(kind=c_int), parameter, public :: GL_ONE_MINUS_DST_ALPHA = int(z'0305')
    integer(kind=c_int), parameter, public :: GL_DST_COLOR           = int(z'0306')
    integer(kind=c_int), parameter, public :: GL_ONE_MINUS_DST_COLOR = int(z'0307')
    integer(kind=c_int), parameter, public :: GL_SRC_ALPHA_SATURATE  = int(z'0308')

    ! Render Mode
    integer(kind=c_int), parameter, public :: GL_FEEDBACK = int(z'1C01')
    integer(kind=c_int), parameter, public :: GL_RENDER   = int(z'1C00')
    integer(kind=c_int), parameter, public :: GL_SELECT   = int(z'1C02')

    ! Feedback
    integer(kind=c_int), parameter, public :: GL_2D                      = int(z'0600')
    integer(kind=c_int), parameter, public :: GL_3D                      = int(z'0601')
    integer(kind=c_int), parameter, public :: GL_3D_COLOR                = int(z'0602')
    integer(kind=c_int), parameter, public :: GL_3D_COLOR_TEXTURE        = int(z'0603')
    integer(kind=c_int), parameter, public :: GL_4D_COLOR_TEXTURE        = int(z'0604')
    integer(kind=c_int), parameter, public :: GL_POINT_TOKEN             = int(z'0701')
    integer(kind=c_int), parameter, public :: GL_LINE_TOKEN              = int(z'0702')
    integer(kind=c_int), parameter, public :: GL_LINE_RESET_TOKEN        = int(z'0707')
    integer(kind=c_int), parameter, public :: GL_POLYGON_TOKEN           = int(z'0703')
    integer(kind=c_int), parameter, public :: GL_BITMAP_TOKEN            = int(z'0704')
    integer(kind=c_int), parameter, public :: GL_DRAW_PIXEL_TOKEN        = int(z'0705')
    integer(kind=c_int), parameter, public :: GL_COPY_PIXEL_TOKEN        = int(z'0706')
    integer(kind=c_int), parameter, public :: GL_PASS_THROUGH_TOKEN      = int(z'0700')
    integer(kind=c_int), parameter, public :: GL_FEEDBACK_BUFFER_POINTER = int(z'0DF0')
    integer(kind=c_int), parameter, public :: GL_FEEDBACK_BUFFER_SIZE    = int(z'0DF1')
    integer(kind=c_int), parameter, public :: GL_FEEDBACK_BUFFER_TYPE    = int(z'0DF2')

    ! Selection
    integer(kind=c_int), parameter, public :: GL_SELECTION_BUFFER_POINTER = int(z'0DF3')
    integer(kind=c_int), parameter, public :: GL_SELECTION_BUFFER_SIZE    = int(z'0DF4')

    ! Fog
    integer(kind=c_int), parameter, public :: GL_FOG         = int(z'0B60')
    integer(kind=c_int), parameter, public :: GL_FOG_MODE    = int(z'0B65')
    integer(kind=c_int), parameter, public :: GL_FOG_DENSITY = int(z'0B62')
    integer(kind=c_int), parameter, public :: GL_FOG_COLOR   = int(z'0B66')
    integer(kind=c_int), parameter, public :: GL_FOG_INDEX   = int(z'0B61')
    integer(kind=c_int), parameter, public :: GL_FOG_START   = int(z'0B63')
    integer(kind=c_int), parameter, public :: GL_FOG_END     = int(z'0B64')
    integer(kind=c_int), parameter, public :: GL_LINEAR      = int(z'2601')
    integer(kind=c_int), parameter, public :: GL_EXP         = int(z'0800')
    integer(kind=c_int), parameter, public :: GL_EXP2        = int(z'0801')

    ! Logic Ops
    integer(kind=c_int), parameter, public :: GL_LOGIC_OP       = int(z'0BF1')
    integer(kind=c_int), parameter, public :: GL_INDEX_LOGIC_OP = int(z'0BF1')
    integer(kind=c_int), parameter, public :: GL_COLOR_LOGIC_OP = int(z'0BF2')
    integer(kind=c_int), parameter, public :: GL_LOGIC_OP_MODE  = int(z'0BF0')
    integer(kind=c_int), parameter, public :: GL_CLEAR          = int(z'1500')
    integer(kind=c_int), parameter, public :: GL_SET            = int(z'150F')
    integer(kind=c_int), parameter, public :: GL_COPY           = int(z'1503')
    integer(kind=c_int), parameter, public :: GL_COPY_INVERTED  = int(z'150C')
    integer(kind=c_int), parameter, public :: GL_NOOP           = int(z'1505')
    integer(kind=c_int), parameter, public :: GL_INVERT         = int(z'150A')
    integer(kind=c_int), parameter, public :: GL_AND            = int(z'1501')
    integer(kind=c_int), parameter, public :: GL_NAND           = int(z'150E')
    integer(kind=c_int), parameter, public :: GL_OR             = int(z'1507')
    integer(kind=c_int), parameter, public :: GL_NOR            = int(z'1508')
    integer(kind=c_int), parameter, public :: GL_XOR            = int(z'1506')
    integer(kind=c_int), parameter, public :: GL_EQUIV          = int(z'1509')
    integer(kind=c_int), parameter, public :: GL_AND_REVERSE    = int(z'1502')
    integer(kind=c_int), parameter, public :: GL_AND_INVERTED   = int(z'1504')
    integer(kind=c_int), parameter, public :: GL_OR_REVERSE     = int(z'150B')
    integer(kind=c_int), parameter, public :: GL_OR_INVERTED    = int(z'150D')

    ! Stencil
    integer(kind=c_int), parameter, public :: GL_STENCIL_BITS            = int(z'0D57')
    integer(kind=c_int), parameter, public :: GL_STENCIL_TEST            = int(z'0B90')
    integer(kind=c_int), parameter, public :: GL_STENCIL_CLEAR_VALUE     = int(z'0B91')
    integer(kind=c_int), parameter, public :: GL_STENCIL_FUNC            = int(z'0B92')
    integer(kind=c_int), parameter, public :: GL_STENCIL_VALUE_MASK      = int(z'0B93')
    integer(kind=c_int), parameter, public :: GL_STENCIL_FAIL            = int(z'0B94')
    integer(kind=c_int), parameter, public :: GL_STENCIL_PASS_DEPTH_FAIL = int(z'0B95')
    integer(kind=c_int), parameter, public :: GL_STENCIL_PASS_DEPTH_PASS = int(z'0B96')
    integer(kind=c_int), parameter, public :: GL_STENCIL_REF             = int(z'0B97')
    integer(kind=c_int), parameter, public :: GL_STENCIL_WRITEMASK       = int(z'0B98')
    integer(kind=c_int), parameter, public :: GL_STENCIL_INDEX           = int(z'1901')
    integer(kind=c_int), parameter, public :: GL_KEEP                    = int(z'1E00')
    integer(kind=c_int), parameter, public :: GL_REPLACE                 = int(z'1E01')
    integer(kind=c_int), parameter, public :: GL_INCR                    = int(z'1E02')
    integer(kind=c_int), parameter, public :: GL_DECR                    = int(z'1E03')

    ! Buffers, Pixel Drawing/Reading
    integer(kind=c_int), parameter, public :: GL_NONE            = 0
    integer(kind=c_int), parameter, public :: GL_LEFT            = int(z'0406')
    integer(kind=c_int), parameter, public :: GL_RIGHT           = int(z'0407')
    integer(kind=c_int), parameter, public :: GL_FRONT_LEFT      = int(z'0400')
    integer(kind=c_int), parameter, public :: GL_FRONT_RIGHT     = int(z'0401')
    integer(kind=c_int), parameter, public :: GL_BACK_LEFT       = int(z'0402')
    integer(kind=c_int), parameter, public :: GL_BACK_RIGHT      = int(z'0403')
    integer(kind=c_int), parameter, public :: GL_AUX0            = int(z'0409')
    integer(kind=c_int), parameter, public :: GL_AUX1            = int(z'040A')
    integer(kind=c_int), parameter, public :: GL_AUX2            = int(z'040B')
    integer(kind=c_int), parameter, public :: GL_AUX3            = int(z'040C')
    integer(kind=c_int), parameter, public :: GL_COLOR_INDEX     = int(z'1900')
    integer(kind=c_int), parameter, public :: GL_RED             = int(z'1903')
    integer(kind=c_int), parameter, public :: GL_GREEN           = int(z'1904')
    integer(kind=c_int), parameter, public :: GL_BLUE            = int(z'1905')
    integer(kind=c_int), parameter, public :: GL_ALPHA           = int(z'1906')
    integer(kind=c_int), parameter, public :: GL_LUMINANCE       = int(z'1909')
    integer(kind=c_int), parameter, public :: GL_LUMINANCE_ALPHA = int(z'190A')
    integer(kind=c_int), parameter, public :: GL_ALPHA_BITS      = int(z'0D55')
    integer(kind=c_int), parameter, public :: GL_RED_BITS        = int(z'0D52')
    integer(kind=c_int), parameter, public :: GL_GREEN_BITS      = int(z'0D53')
    integer(kind=c_int), parameter, public :: GL_BLUE_BITS       = int(z'0D54')
    integer(kind=c_int), parameter, public :: GL_INDEX_BITS      = int(z'0D51')
    integer(kind=c_int), parameter, public :: GL_SUBPIXEL_BITS   = int(z'0D50')
    integer(kind=c_int), parameter, public :: GL_AUX_BUFFERS     = int(z'0C00')
    integer(kind=c_int), parameter, public :: GL_READ_BUFFER     = int(z'0C02')
    integer(kind=c_int), parameter, public :: GL_DRAW_BUFFER     = int(z'0C01')
    integer(kind=c_int), parameter, public :: GL_DOUBLEBUFFER    = int(z'0C32')
    integer(kind=c_int), parameter, public :: GL_STEREO          = int(z'0C33')
    integer(kind=c_int), parameter, public :: GL_BITMAP          = int(z'1A00')
    integer(kind=c_int), parameter, public :: GL_COLOR           = int(z'1800')
    integer(kind=c_int), parameter, public :: GL_DEPTH           = int(z'1801')
    integer(kind=c_int), parameter, public :: GL_STENCIL         = int(z'1802')
    integer(kind=c_int), parameter, public :: GL_DITHER          = int(z'0BD0')
    integer(kind=c_int), parameter, public :: GL_RGB             = int(z'1907')
    integer(kind=c_int), parameter, public :: GL_RGBA            = int(z'1908')

    ! Implementation limits
    integer(kind=c_int), parameter, public :: GL_MAX_LIST_NESTING              = int(z'0B31')
    integer(kind=c_int), parameter, public :: GL_MAX_EVAL_ORDER                = int(z'0D30')
    integer(kind=c_int), parameter, public :: GL_MAX_LIGHTS                    = int(z'0D31')
    integer(kind=c_int), parameter, public :: GL_MAX_CLIP_PLANES               = int(z'0D32')
    integer(kind=c_int), parameter, public :: GL_MAX_TEXTURE_SIZE              = int(z'0D33')
    integer(kind=c_int), parameter, public :: GL_MAX_PIXEL_MAP_TABLE           = int(z'0D34')
    integer(kind=c_int), parameter, public :: GL_MAX_ATTRIB_STACK_DEPTH        = int(z'0D35')
    integer(kind=c_int), parameter, public :: GL_MAX_MODELVIEW_STACK_DEPTH     = int(z'0D36')
    integer(kind=c_int), parameter, public :: GL_MAX_NAME_STACK_DEPTH          = int(z'0D37')
    integer(kind=c_int), parameter, public :: GL_MAX_PROJECTION_STACK_DEPTH    = int(z'0D38')
    integer(kind=c_int), parameter, public :: GL_MAX_TEXTURE_STACK_DEPTH       = int(z'0D39')
    integer(kind=c_int), parameter, public :: GL_MAX_VIEWPORT_DIMS             = int(z'0D3A')
    integer(kind=c_int), parameter, public :: GL_MAX_CLIENT_ATTRIB_STACK_DEPTH = int(z'0D3B')

    ! Gets
    integer(kind=c_int), parameter, public :: GL_ATTRIB_STACK_DEPTH            = int(z'0BB0')
    integer(kind=c_int), parameter, public :: GL_CLIENT_ATTRIB_STACK_DEPTH     = int(z'0BB1')
    integer(kind=c_int), parameter, public :: GL_COLOR_CLEAR_VALUE             = int(z'0C22')
    integer(kind=c_int), parameter, public :: GL_COLOR_WRITEMASK               = int(z'0C23')
    integer(kind=c_int), parameter, public :: GL_CURRENT_INDEX                 = int(z'0B01')
    integer(kind=c_int), parameter, public :: GL_CURRENT_COLOR                 = int(z'0B00')
    integer(kind=c_int), parameter, public :: GL_CURRENT_NORMAL                = int(z'0B02')
    integer(kind=c_int), parameter, public :: GL_CURRENT_RASTER_COLOR          = int(z'0B04')
    integer(kind=c_int), parameter, public :: GL_CURRENT_RASTER_DISTANCE       = int(z'0B09')
    integer(kind=c_int), parameter, public :: GL_CURRENT_RASTER_INDEX          = int(z'0B05')
    integer(kind=c_int), parameter, public :: GL_CURRENT_RASTER_POSITION       = int(z'0B07')
    integer(kind=c_int), parameter, public :: GL_CURRENT_RASTER_TEXTURE_COORDS = int(z'0B06')
    integer(kind=c_int), parameter, public :: GL_CURRENT_RASTER_POSITION_VALID = int(z'0B08')
    integer(kind=c_int), parameter, public :: GL_CURRENT_TEXTURE_COORDS        = int(z'0B03')
    integer(kind=c_int), parameter, public :: GL_INDEX_CLEAR_VALUE             = int(z'0C20')
    integer(kind=c_int), parameter, public :: GL_INDEX_MODE                    = int(z'0C30')
    integer(kind=c_int), parameter, public :: GL_INDEX_WRITEMASK               = int(z'0C21')
    integer(kind=c_int), parameter, public :: GL_MODELVIEW_MATRIX              = int(z'0BA6')
    integer(kind=c_int), parameter, public :: GL_MODELVIEW_STACK_DEPTH         = int(z'0BA3')
    integer(kind=c_int), parameter, public :: GL_NAME_STACK_DEPTH              = int(z'0D70')
    integer(kind=c_int), parameter, public :: GL_PROJECTION_MATRIX             = int(z'0BA7')
    integer(kind=c_int), parameter, public :: GL_PROJECTION_STACK_DEPTH        = int(z'0BA4')
    integer(kind=c_int), parameter, public :: GL_RENDER_MODE                   = int(z'0C40')
    integer(kind=c_int), parameter, public :: GL_RGBA_MODE                     = int(z'0C31')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_MATRIX                = int(z'0BA8')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_STACK_DEPTH           = int(z'0BA5')
    integer(kind=c_int), parameter, public :: GL_VIEWPORT                      = int(z'0BA2')

    ! Evaluators
    integer(kind=c_int), parameter, public :: GL_AUTO_NORMAL          = int(z'0D80')
    integer(kind=c_int), parameter, public :: GL_MAP1_COLOR_4         = int(z'0D90')
    integer(kind=c_int), parameter, public :: GL_MAP1_INDEX           = int(z'0D91')
    integer(kind=c_int), parameter, public :: GL_MAP1_NORMAL          = int(z'0D92')
    integer(kind=c_int), parameter, public :: GL_MAP1_TEXTURE_COORD_1 = int(z'0D93')
    integer(kind=c_int), parameter, public :: GL_MAP1_TEXTURE_COORD_2 = int(z'0D94')
    integer(kind=c_int), parameter, public :: GL_MAP1_TEXTURE_COORD_3 = int(z'0D95')
    integer(kind=c_int), parameter, public :: GL_MAP1_TEXTURE_COORD_4 = int(z'0D96')
    integer(kind=c_int), parameter, public :: GL_MAP1_VERTEX_3        = int(z'0D97')
    integer(kind=c_int), parameter, public :: GL_MAP1_VERTEX_4        = int(z'0D98')
    integer(kind=c_int), parameter, public :: GL_MAP2_COLOR_4         = int(z'0DB0')
    integer(kind=c_int), parameter, public :: GL_MAP2_INDEX           = int(z'0DB1')
    integer(kind=c_int), parameter, public :: GL_MAP2_NORMAL          = int(z'0DB2')
    integer(kind=c_int), parameter, public :: GL_MAP2_TEXTURE_COORD_1 = int(z'0DB3')
    integer(kind=c_int), parameter, public :: GL_MAP2_TEXTURE_COORD_2 = int(z'0DB4')
    integer(kind=c_int), parameter, public :: GL_MAP2_TEXTURE_COORD_3 = int(z'0DB5')
    integer(kind=c_int), parameter, public :: GL_MAP2_TEXTURE_COORD_4 = int(z'0DB6')
    integer(kind=c_int), parameter, public :: GL_MAP2_VERTEX_3        = int(z'0DB7')
    integer(kind=c_int), parameter, public :: GL_MAP2_VERTEX_4        = int(z'0DB8')
    integer(kind=c_int), parameter, public :: GL_MAP1_GRID_DOMAIN     = int(z'0DD0')
    integer(kind=c_int), parameter, public :: GL_MAP1_GRID_SEGMENTS   = int(z'0DD1')
    integer(kind=c_int), parameter, public :: GL_MAP2_GRID_DOMAIN     = int(z'0DD2')
    integer(kind=c_int), parameter, public :: GL_MAP2_GRID_SEGMENTS   = int(z'0DD3')
    integer(kind=c_int), parameter, public :: GL_COEFF                = int(z'0A00')
    integer(kind=c_int), parameter, public :: GL_ORDER                = int(z'0A01')
    integer(kind=c_int), parameter, public :: GL_DOMAIN               = int(z'0A02')

    ! Hints
    integer(kind=c_int), parameter, public :: GL_PERSPECTIVE_CORRECTION_HINT = int(z'0C50')
    integer(kind=c_int), parameter, public :: GL_POINT_SMOOTH_HINT           = int(z'0C51')
    integer(kind=c_int), parameter, public :: GL_LINE_SMOOTH_HINT            = int(z'0C52')
    integer(kind=c_int), parameter, public :: GL_POLYGON_SMOOTH_HINT         = int(z'0C53')
    integer(kind=c_int), parameter, public :: GL_FOG_HINT                    = int(z'0C54')
    integer(kind=c_int), parameter, public :: GL_DONT_CARE                   = int(z'1100')
    integer(kind=c_int), parameter, public :: GL_FASTEST                     = int(z'1101')
    integer(kind=c_int), parameter, public :: GL_NICEST                      = int(z'1102')

    ! Scissor box
    integer(kind=c_int), parameter, public :: GL_SCISSOR_BOX  = int(z'0C10')
    integer(kind=c_int), parameter, public :: GL_SCISSOR_TEST = int(z'0C11')

    ! Pixel Mode / Transfer
    integer(kind=c_int), parameter, public :: GL_MAP_COLOR             = int(z'0D10')
    integer(kind=c_int), parameter, public :: GL_MAP_STENCIL           = int(z'0D11')
    integer(kind=c_int), parameter, public :: GL_INDEX_SHIFT           = int(z'0D12')
    integer(kind=c_int), parameter, public :: GL_INDEX_OFFSET          = int(z'0D13')
    integer(kind=c_int), parameter, public :: GL_RED_SCALE             = int(z'0D14')
    integer(kind=c_int), parameter, public :: GL_RED_BIAS              = int(z'0D15')
    integer(kind=c_int), parameter, public :: GL_GREEN_SCALE           = int(z'0D18')
    integer(kind=c_int), parameter, public :: GL_GREEN_BIAS            = int(z'0D19')
    integer(kind=c_int), parameter, public :: GL_BLUE_SCALE            = int(z'0D1A')
    integer(kind=c_int), parameter, public :: GL_BLUE_BIAS             = int(z'0D1B')
    integer(kind=c_int), parameter, public :: GL_ALPHA_SCALE           = int(z'0D1C')
    integer(kind=c_int), parameter, public :: GL_ALPHA_BIAS            = int(z'0D1D')
    integer(kind=c_int), parameter, public :: GL_DEPTH_SCALE           = int(z'0D1E')
    integer(kind=c_int), parameter, public :: GL_DEPTH_BIAS            = int(z'0D1F')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MAP_S_TO_S_SIZE = int(z'0CB1')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MAP_I_TO_I_SIZE = int(z'0CB0')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MAP_I_TO_R_SIZE = int(z'0CB2')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MAP_I_TO_G_SIZE = int(z'0CB3')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MAP_I_TO_B_SIZE = int(z'0CB4')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MAP_I_TO_A_SIZE = int(z'0CB5')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MAP_R_TO_R_SIZE = int(z'0CB6')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MAP_G_TO_G_SIZE = int(z'0CB7')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MAP_B_TO_B_SIZE = int(z'0CB8')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MAP_A_TO_A_SIZE = int(z'0CB9')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MAP_S_TO_S      = int(z'0C71')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MAP_I_TO_I      = int(z'0C70')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MAP_I_TO_R      = int(z'0C72')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MAP_I_TO_G      = int(z'0C73')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MAP_I_TO_B      = int(z'0C74')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MAP_I_TO_A      = int(z'0C75')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MAP_R_TO_R      = int(z'0C76')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MAP_G_TO_G      = int(z'0C77')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MAP_B_TO_B      = int(z'0C78')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MAP_A_TO_A      = int(z'0C79')
    integer(kind=c_int), parameter, public :: GL_PACK_ALIGNMENT        = int(z'0D05')
    integer(kind=c_int), parameter, public :: GL_PACK_LSB_FIRST        = int(z'0D01')
    integer(kind=c_int), parameter, public :: GL_PACK_ROW_LENGTH       = int(z'0D02')
    integer(kind=c_int), parameter, public :: GL_PACK_SKIP_PIXELS      = int(z'0D04')
    integer(kind=c_int), parameter, public :: GL_PACK_SKIP_ROWS        = int(z'0D03')
    integer(kind=c_int), parameter, public :: GL_PACK_SWAP_BYTES       = int(z'0D00')
    integer(kind=c_int), parameter, public :: GL_UNPACK_ALIGNMENT      = int(z'0CF5')
    integer(kind=c_int), parameter, public :: GL_UNPACK_LSB_FIRST      = int(z'0CF1')
    integer(kind=c_int), parameter, public :: GL_UNPACK_ROW_LENGTH     = int(z'0CF2')
    integer(kind=c_int), parameter, public :: GL_UNPACK_SKIP_PIXELS    = int(z'0CF4')
    integer(kind=c_int), parameter, public :: GL_UNPACK_SKIP_ROWS      = int(z'0CF3')
    integer(kind=c_int), parameter, public :: GL_UNPACK_SWAP_BYTES     = int(z'0CF0')
    integer(kind=c_int), parameter, public :: GL_ZOOM_X                = int(z'0D16')
    integer(kind=c_int), parameter, public :: GL_ZOOM_Y                = int(z'0D17')

    ! Texture mapping
    integer(kind=c_int), parameter, public :: GL_TEXTURE_ENV            = int(z'2300')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_ENV_MODE       = int(z'2200')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_1D             = int(z'0DE0')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_2D             = int(z'0DE1')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_WRAP_S         = int(z'2802')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_WRAP_T         = int(z'2803')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_MAG_FILTER     = int(z'2800')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_MIN_FILTER     = int(z'2801')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_ENV_COLOR      = int(z'2201')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_GEN_S          = int(z'0C60')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_GEN_T          = int(z'0C61')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_GEN_R          = int(z'0C62')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_GEN_Q          = int(z'0C63')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_GEN_MODE       = int(z'2500')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_BORDER_COLOR   = int(z'1004')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_WIDTH          = int(z'1000')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_HEIGHT         = int(z'1001')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_BORDER         = int(z'1005')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_COMPONENTS     = int(z'1003')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_RED_SIZE       = int(z'805C')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_GREEN_SIZE     = int(z'805D')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_BLUE_SIZE      = int(z'805E')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_ALPHA_SIZE     = int(z'805F')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_LUMINANCE_SIZE = int(z'8060')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_INTENSITY_SIZE = int(z'8061')
    integer(kind=c_int), parameter, public :: GL_NEAREST_MIPMAP_NEAREST = int(z'2700')
    integer(kind=c_int), parameter, public :: GL_NEAREST_MIPMAP_LINEAR  = int(z'2702')
    integer(kind=c_int), parameter, public :: GL_LINEAR_MIPMAP_NEAREST  = int(z'2701')
    integer(kind=c_int), parameter, public :: GL_LINEAR_MIPMAP_LINEAR   = int(z'2703')
    integer(kind=c_int), parameter, public :: GL_OBJECT_LINEAR          = int(z'2401')
    integer(kind=c_int), parameter, public :: GL_OBJECT_PLANE           = int(z'2501')
    integer(kind=c_int), parameter, public :: GL_EYE_LINEAR             = int(z'2400')
    integer(kind=c_int), parameter, public :: GL_EYE_PLANE              = int(z'2502')
    integer(kind=c_int), parameter, public :: GL_SPHERE_MAP             = int(z'2402')
    integer(kind=c_int), parameter, public :: GL_DECAL                  = int(z'2101')
    integer(kind=c_int), parameter, public :: GL_MODULATE               = int(z'2100')
    integer(kind=c_int), parameter, public :: GL_NEAREST                = int(z'2600')
    integer(kind=c_int), parameter, public :: GL_REPEAT                 = int(z'2901')
    integer(kind=c_int), parameter, public :: GL_CLAMP                  = int(z'2900')
    integer(kind=c_int), parameter, public :: GL_S                      = int(z'2000')
    integer(kind=c_int), parameter, public :: GL_T                      = int(z'2001')
    integer(kind=c_int), parameter, public :: GL_R                      = int(z'2002')
    integer(kind=c_int), parameter, public :: GL_Q                      = int(z'2003')

    ! Utility
    integer(kind=c_int), parameter, public :: GL_VENDOR     = int(z'1F00')
    integer(kind=c_int), parameter, public :: GL_RENDERER   = int(z'1F01')
    integer(kind=c_int), parameter, public :: GL_VERSION    = int(z'1F02')
    integer(kind=c_int), parameter, public :: GL_EXTENSIONS = int(z'1F03')

    ! Errors
    integer(kind=c_int), parameter, public :: GL_NO_ERROR          = 0
    integer(kind=c_int), parameter, public :: GL_INVALID_ENUM      = int(z'0500')
    integer(kind=c_int), parameter, public :: GL_INVALID_VALUE     = int(z'0501')
    integer(kind=c_int), parameter, public :: GL_INVALID_OPERATION = int(z'0502')
    integer(kind=c_int), parameter, public :: GL_STACK_OVERFLOW    = int(z'0503')
    integer(kind=c_int), parameter, public :: GL_STACK_UNDERFLOW   = int(z'0504')
    integer(kind=c_int), parameter, public :: GL_OUT_OF_MEMORY     = int(z'0505')

    ! glPush/PopAttrib bits
    integer(kind=c_int), parameter, public :: GL_CURRENT_BIT         = int(z'00000001')
    integer(kind=c_int), parameter, public :: GL_POINT_BIT           = int(z'00000002')
    integer(kind=c_int), parameter, public :: GL_LINE_BIT            = int(z'00000004')
    integer(kind=c_int), parameter, public :: GL_POLYGON_BIT         = int(z'00000008')
    integer(kind=c_int), parameter, public :: GL_POLYGON_STIPPLE_BIT = int(z'00000010')
    integer(kind=c_int), parameter, public :: GL_PIXEL_MODE_BIT      = int(z'00000020')
    integer(kind=c_int), parameter, public :: GL_LIGHTING_BIT        = int(z'00000040')
    integer(kind=c_int), parameter, public :: GL_FOG_BIT             = int(z'00000080')
    integer(kind=c_int), parameter, public :: GL_DEPTH_BUFFER_BIT    = int(z'00000100')
    integer(kind=c_int), parameter, public :: GL_ACCUM_BUFFER_BIT    = int(z'00000200')
    integer(kind=c_int), parameter, public :: GL_STENCIL_BUFFER_BIT  = int(z'00000400')
    integer(kind=c_int), parameter, public :: GL_VIEWPORT_BIT        = int(z'00000800')
    integer(kind=c_int), parameter, public :: GL_TRANSFORM_BIT       = int(z'00001000')
    integer(kind=c_int), parameter, public :: GL_ENABLE_BIT          = int(z'00002000')
    integer(kind=c_int), parameter, public :: GL_COLOR_BUFFER_BIT    = int(z'00004000')
    integer(kind=c_int), parameter, public :: GL_HINT_BIT            = int(z'00008000')
    integer(kind=c_int), parameter, public :: GL_EVAL_BIT            = int(z'00010000')
    integer(kind=c_int), parameter, public :: GL_LIST_BIT            = int(z'00020000')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_BIT         = int(z'00040000')
    integer(kind=c_int), parameter, public :: GL_SCISSOR_BIT         = int(z'00080000')
    integer(kind=c_int), parameter, public :: GL_ALL_ATTRIB_BITS     = int(z'000FFFFF')

    ! OpenGL 1.1
    integer(kind=c_int), parameter, public :: GL_PROXY_TEXTURE_1D        = int(z'8063')
    integer(kind=c_int), parameter, public :: GL_PROXY_TEXTURE_2D        = int(z'8064')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_PRIORITY        = int(z'8066')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_RESIDENT        = int(z'8067')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_BINDING_1D      = int(z'8068')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_BINDING_2D      = int(z'8069')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_INTERNAL_FORMAT = int(z'1003')
    integer(kind=c_int), parameter, public :: GL_ALPHA4                  = int(z'803B')
    integer(kind=c_int), parameter, public :: GL_ALPHA8                  = int(z'803C')
    integer(kind=c_int), parameter, public :: GL_ALPHA12                 = int(z'803D')
    integer(kind=c_int), parameter, public :: GL_ALPHA16                 = int(z'803E')
    integer(kind=c_int), parameter, public :: GL_LUMINANCE4              = int(z'803F')
    integer(kind=c_int), parameter, public :: GL_LUMINANCE8              = int(z'8040')
    integer(kind=c_int), parameter, public :: GL_LUMINANCE12             = int(z'8041')
    integer(kind=c_int), parameter, public :: GL_LUMINANCE16             = int(z'8042')
    integer(kind=c_int), parameter, public :: GL_LUMINANCE4_ALPHA4       = int(z'8043')
    integer(kind=c_int), parameter, public :: GL_LUMINANCE6_ALPHA2       = int(z'8044')
    integer(kind=c_int), parameter, public :: GL_LUMINANCE8_ALPHA8       = int(z'8045')
    integer(kind=c_int), parameter, public :: GL_LUMINANCE12_ALPHA4      = int(z'8046')
    integer(kind=c_int), parameter, public :: GL_LUMINANCE12_ALPHA12     = int(z'8047')
    integer(kind=c_int), parameter, public :: GL_LUMINANCE16_ALPHA16     = int(z'8048')
    integer(kind=c_int), parameter, public :: GL_INTENSITY               = int(z'8049')
    integer(kind=c_int), parameter, public :: GL_INTENSITY4              = int(z'804A')
    integer(kind=c_int), parameter, public :: GL_INTENSITY8              = int(z'804B')
    integer(kind=c_int), parameter, public :: GL_INTENSITY12             = int(z'804C')
    integer(kind=c_int), parameter, public :: GL_INTENSITY16             = int(z'804D')
    integer(kind=c_int), parameter, public :: GL_R3_G3_B2                = int(z'2A10')
    integer(kind=c_int), parameter, public :: GL_RGB4                    = int(z'804F')
    integer(kind=c_int), parameter, public :: GL_RGB5                    = int(z'8050')
    integer(kind=c_int), parameter, public :: GL_RGB8                    = int(z'8051')
    integer(kind=c_int), parameter, public :: GL_RGB10                   = int(z'8052')
    integer(kind=c_int), parameter, public :: GL_RGB12                   = int(z'8053')
    integer(kind=c_int), parameter, public :: GL_RGB16                   = int(z'8054')
    integer(kind=c_int), parameter, public :: GL_RGBA2                   = int(z'8055')
    integer(kind=c_int), parameter, public :: GL_RGBA4                   = int(z'8056')
    integer(kind=c_int), parameter, public :: GL_RGB5_A1                 = int(z'8057')
    integer(kind=c_int), parameter, public :: GL_RGBA8                   = int(z'8058')
    integer(kind=c_int), parameter, public :: GL_RGB10_A2                = int(z'8059')
    integer(kind=c_int), parameter, public :: GL_RGBA12                  = int(z'805A')
    integer(kind=c_int), parameter, public :: GL_RGBA16                  = int(z'805B')

    integer(kind=c_long), parameter, public :: GL_CLIENT_PIXEL_STORE_BIT  = int(z'00000001', kind=c_long)
    integer(kind=c_long), parameter, public :: GL_CLIENT_VERTEX_ARRAY_BIT = int(z'00000002', kind=c_long)
    integer(kind=c_long), parameter, public :: GL_ALL_CLIENT_ATTRIB_BITS  = int(z'FFFFFFFF', kind=c_long)
    integer(kind=c_long), parameter, public :: GL_CLIENT_ALL_ATTRIB_BITS  = int(z'FFFFFFFF', kind=c_long)

    ! OpenGL 1.3
    ! multitexture
    integer(kind=c_int), parameter, public :: GL_TEXTURE0              = int(z'84C0')
    integer(kind=c_int), parameter, public :: GL_TEXTURE1              = int(z'84C1')
    integer(kind=c_int), parameter, public :: GL_TEXTURE2              = int(z'84C2')
    integer(kind=c_int), parameter, public :: GL_TEXTURE3              = int(z'84C3')
    integer(kind=c_int), parameter, public :: GL_TEXTURE4              = int(z'84C4')
    integer(kind=c_int), parameter, public :: GL_TEXTURE5              = int(z'84C5')
    integer(kind=c_int), parameter, public :: GL_TEXTURE6              = int(z'84C6')
    integer(kind=c_int), parameter, public :: GL_TEXTURE7              = int(z'84C7')
    integer(kind=c_int), parameter, public :: GL_TEXTURE8              = int(z'84C8')
    integer(kind=c_int), parameter, public :: GL_TEXTURE9              = int(z'84C9')
    integer(kind=c_int), parameter, public :: GL_TEXTURE10             = int(z'84CA')
    integer(kind=c_int), parameter, public :: GL_TEXTURE11             = int(z'84CB')
    integer(kind=c_int), parameter, public :: GL_TEXTURE12             = int(z'84CC')
    integer(kind=c_int), parameter, public :: GL_TEXTURE13             = int(z'84CD')
    integer(kind=c_int), parameter, public :: GL_TEXTURE14             = int(z'84CE')
    integer(kind=c_int), parameter, public :: GL_TEXTURE15             = int(z'84CF')
    integer(kind=c_int), parameter, public :: GL_TEXTURE16             = int(z'84D0')
    integer(kind=c_int), parameter, public :: GL_TEXTURE17             = int(z'84D1')
    integer(kind=c_int), parameter, public :: GL_TEXTURE18             = int(z'84D2')
    integer(kind=c_int), parameter, public :: GL_TEXTURE19             = int(z'84D3')
    integer(kind=c_int), parameter, public :: GL_TEXTURE20             = int(z'84D4')
    integer(kind=c_int), parameter, public :: GL_TEXTURE21             = int(z'84D5')
    integer(kind=c_int), parameter, public :: GL_TEXTURE22             = int(z'84D6')
    integer(kind=c_int), parameter, public :: GL_TEXTURE23             = int(z'84D7')
    integer(kind=c_int), parameter, public :: GL_TEXTURE24             = int(z'84D8')
    integer(kind=c_int), parameter, public :: GL_TEXTURE25             = int(z'84D9')
    integer(kind=c_int), parameter, public :: GL_TEXTURE26             = int(z'84DA')
    integer(kind=c_int), parameter, public :: GL_TEXTURE27             = int(z'84DB')
    integer(kind=c_int), parameter, public :: GL_TEXTURE28             = int(z'84DC')
    integer(kind=c_int), parameter, public :: GL_TEXTURE29             = int(z'84DD')
    integer(kind=c_int), parameter, public :: GL_TEXTURE30             = int(z'84DE')
    integer(kind=c_int), parameter, public :: GL_TEXTURE31             = int(z'84DF')
    integer(kind=c_int), parameter, public :: GL_ACTIVE_TEXTURE        = int(z'84E0')
    integer(kind=c_int), parameter, public :: GL_CLIENT_ACTIVE_TEXTURE = int(z'84E1')
    integer(kind=c_int), parameter, public :: GL_MAX_TEXTURE_UNITS     = int(z'84E2')

    ! texture_cube_map
    integer(kind=c_int), parameter, public :: GL_NORMAL_MAP                  = int(z'8511')
    integer(kind=c_int), parameter, public :: GL_REFLECTION_MAP              = int(z'8512')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_CUBE_MAP            = int(z'8513')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_BINDING_CUBE_MAP    = int(z'8514')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_CUBE_MAP_POSITIVE_X = int(z'8515')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_CUBE_MAP_NEGATIVE_X = int(z'8516')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_CUBE_MAP_POSITIVE_Y = int(z'8517')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_CUBE_MAP_NEGATIVE_Y = int(z'8518')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_CUBE_MAP_POSITIVE_Z = int(z'8519')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_CUBE_MAP_NEGATIVE_Z = int(z'851A')
    integer(kind=c_int), parameter, public :: GL_PROXY_TEXTURE_CUBE_MAP      = int(z'851B')
    integer(kind=c_int), parameter, public :: GL_MAX_CUBE_MAP_TEXTURE_SIZE   = int(z'851C')

    ! texture_compression
    integer(kind=c_int), parameter, public :: GL_COMPRESSED_ALPHA               = int(z'84E9')
    integer(kind=c_int), parameter, public :: GL_COMPRESSED_LUMINANCE           = int(z'84EA')
    integer(kind=c_int), parameter, public :: GL_COMPRESSED_LUMINANCE_ALPHA     = int(z'84EB')
    integer(kind=c_int), parameter, public :: GL_COMPRESSED_INTENSITY           = int(z'84EC')
    integer(kind=c_int), parameter, public :: GL_COMPRESSED_RGB                 = int(z'84ED')
    integer(kind=c_int), parameter, public :: GL_COMPRESSED_RGBA                = int(z'84EE')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_COMPRESSION_HINT       = int(z'84EF')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_COMPRESSED_IMAGE_SIZE  = int(z'86A0')
    integer(kind=c_int), parameter, public :: GL_TEXTURE_COMPRESSED             = int(z'86A1')
    integer(kind=c_int), parameter, public :: GL_NUM_COMPRESSED_TEXTURE_FORMATS = int(z'86A2')
    integer(kind=c_int), parameter, public :: GL_COMPRESSED_TEXTURE_FORMATS     = int(z'86A3')

    ! multisample
    integer(kind=c_int), parameter, public :: GL_MULTISAMPLE              = int(z'809D')
    integer(kind=c_int), parameter, public :: GL_SAMPLE_ALPHA_TO_COVERAGE = int(z'809E')
    integer(kind=c_int), parameter, public :: GL_SAMPLE_ALPHA_TO_ONE      = int(z'809F')
    integer(kind=c_int), parameter, public :: GL_SAMPLE_COVERAGE          = int(z'80A0')
    integer(kind=c_int), parameter, public :: GL_SAMPLE_BUFFERS           = int(z'80A8')
    integer(kind=c_int), parameter, public :: GL_SAMPLES                  = int(z'80A9')
    integer(kind=c_int), parameter, public :: GL_SAMPLE_COVERAGE_VALUE    = int(z'80AA')
    integer(kind=c_int), parameter, public :: GL_SAMPLE_COVERAGE_INVERT   = int(z'80AB')
    integer(kind=c_int), parameter, public :: GL_MULTISAMPLE_BIT          = int(z'20000000')

    ! transpose_matrix
    integer(kind=c_int), parameter, public :: GL_TRANSPOSE_MODELVIEW_MATRIX  = int(z'84E3')
    integer(kind=c_int), parameter, public :: GL_TRANSPOSE_PROJECTION_MATRIX = int(z'84E4')
    integer(kind=c_int), parameter, public :: GL_TRANSPOSE_TEXTURE_MATRIX    = int(z'84E5')
    integer(kind=c_int), parameter, public :: GL_TRANSPOSE_COLOR_MATRIX      = int(z'84E6')

    ! texture_env_combine
    integer(kind=c_int), parameter, public :: GL_COMBINE        = int(z'8570')
    integer(kind=c_int), parameter, public :: GL_COMBINE_RGB    = int(z'8571')
    integer(kind=c_int), parameter, public :: GL_COMBINE_ALPHA  = int(z'8572')
    integer(kind=c_int), parameter, public :: GL_SOURCE0_RGB    = int(z'8580')
    integer(kind=c_int), parameter, public :: GL_SOURCE1_RGB    = int(z'8581')
    integer(kind=c_int), parameter, public :: GL_SOURCE2_RGB    = int(z'8582')
    integer(kind=c_int), parameter, public :: GL_SOURCE0_ALPHA  = int(z'8588')
    integer(kind=c_int), parameter, public :: GL_SOURCE1_ALPHA  = int(z'8589')
    integer(kind=c_int), parameter, public :: GL_SOURCE2_ALPHA  = int(z'858A')
    integer(kind=c_int), parameter, public :: GL_OPERAND0_RGB   = int(z'8590')
    integer(kind=c_int), parameter, public :: GL_OPERAND1_RGB   = int(z'8591')
    integer(kind=c_int), parameter, public :: GL_OPERAND2_RGB   = int(z'8592')
    integer(kind=c_int), parameter, public :: GL_OPERAND0_ALPHA = int(z'8598')
    integer(kind=c_int), parameter, public :: GL_OPERAND1_ALPHA = int(z'8599')
    integer(kind=c_int), parameter, public :: GL_OPERAND2_ALPHA = int(z'859A')
    integer(kind=c_int), parameter, public :: GL_RGB_SCALE      = int(z'8573')
    integer(kind=c_int), parameter, public :: GL_ADD_SIGNED     = int(z'8574')
    integer(kind=c_int), parameter, public :: GL_INTERPOLATE    = int(z'8575')
    integer(kind=c_int), parameter, public :: GL_SUBTRACT       = int(z'84E7')
    integer(kind=c_int), parameter, public :: GL_CONSTANT       = int(z'8576')
    integer(kind=c_int), parameter, public :: GL_PRIMARY_COLOR  = int(z'8577')
    integer(kind=c_int), parameter, public :: GL_PREVIOUS       = int(z'8578')

    ! texture_env_dot3
    integer(kind=c_int), parameter, public :: GL_DOT3_RGB  = int(z'86AE')
    integer(kind=c_int), parameter, public :: GL_DOT3_RGBA = int(z'86AF')

    ! texture_border_clamp
    integer(kind=c_int), parameter, public :: GL_CLAMP_TO_BORDER = int(z'812D')
