...
module sdl2_opengl
    ...
    ! OpenGL 1.2
    integer(kind=c_int), parameter :: GL_RESCALE_NORMAL                = int(z'803A')
    integer(kind=c_int), parameter :: GL_CLAMP_TO_EDGE                 = int(z'812F')
    integer(kind=c_int), parameter :: GL_MAX_ELEMENTS_VERTICES         = int(z'80E8')
    integer(kind=c_int), parameter :: GL_MAX_ELEMENTS_INDICES          = int(z'80E9')
    integer(kind=c_int), parameter :: GL_BGR                           = int(z'80E0')
    integer(kind=c_int), parameter :: GL_BGRA                          = int(z'80E1')
    integer(kind=c_int), parameter :: GL_UNSIGNED_BYTE_3_3_2           = int(z'8032')
    integer(kind=c_int), parameter :: GL_UNSIGNED_BYTE_2_3_3_REV       = int(z'8362')
    integer(kind=c_int), parameter :: GL_UNSIGNED_SHORT_5_6_5          = int(z'8363')
    integer(kind=c_int), parameter :: GL_UNSIGNED_SHORT_5_6_5_REV      = int(z'8364')
    integer(kind=c_int), parameter :: GL_UNSIGNED_SHORT_4_4_4_4        = int(z'8033')
    integer(kind=c_int), parameter :: GL_UNSIGNED_SHORT_4_4_4_4_REV    = int(z'8365')
    integer(kind=c_int), parameter :: GL_UNSIGNED_SHORT_5_5_5_1        = int(z'8034')
    integer(kind=c_int), parameter :: GL_UNSIGNED_SHORT_1_5_5_5_REV    = int(z'8366')
    integer(kind=c_int), parameter :: GL_UNSIGNED_INT_8_8_8_8          = int(z'8035')
    integer(kind=c_int), parameter :: GL_UNSIGNED_INT_8_8_8_8_REV      = int(z'8367')
    integer(kind=c_int), parameter :: GL_UNSIGNED_INT_10_10_10_2       = int(z'8036')
    integer(kind=c_int), parameter :: GL_UNSIGNED_INT_2_10_10_10_REV   = int(z'8368')
    integer(kind=c_int), parameter :: GL_LIGHT_MODEL_COLOR_CONTROL     = int(z'81F8')
    integer(kind=c_int), parameter :: GL_SINGLE_COLOR                  = int(z'81F9')
    integer(kind=c_int), parameter :: GL_SEPARATE_SPECULAR_COLOR       = int(z'81FA')
    integer(kind=c_int), parameter :: GL_TEXTURE_MIN_LOD               = int(z'813A')
    integer(kind=c_int), parameter :: GL_TEXTURE_MAX_LOD               = int(z'813B')
    integer(kind=c_int), parameter :: GL_TEXTURE_BASE_LEVEL            = int(z'813C')
    integer(kind=c_int), parameter :: GL_TEXTURE_MAX_LEVEL             = int(z'813D')
    integer(kind=c_int), parameter :: GL_SMOOTH_POINT_SIZE_RANGE       = int(z'0B12')
    integer(kind=c_int), parameter :: GL_SMOOTH_POINT_SIZE_GRANULARITY = int(z'0B13')
    integer(kind=c_int), parameter :: GL_SMOOTH_LINE_WIDTH_RANGE       = int(z'0B22')
    integer(kind=c_int), parameter :: GL_SMOOTH_LINE_WIDTH_GRANULARITY = int(z'0B23')
    integer(kind=c_int), parameter :: GL_ALIASED_POINT_SIZE_RANGE      = int(z'846D')
    integer(kind=c_int), parameter :: GL_ALIASED_LINE_WIDTH_RANGE      = int(z'846E')
    integer(kind=c_int), parameter :: GL_PACK_SKIP_IMAGES              = int(z'806B')
    integer(kind=c_int), parameter :: GL_PACK_IMAGE_HEIGHT             = int(z'806C')
    integer(kind=c_int), parameter :: GL_UNPACK_SKIP_IMAGES            = int(z'806D')
    integer(kind=c_int), parameter :: GL_UNPACK_IMAGE_HEIGHT           = int(z'806E')
    integer(kind=c_int), parameter :: GL_TEXTURE_3D                    = int(z'806F')
    integer(kind=c_int), parameter :: GL_PROXY_TEXTURE_3D              = int(z'8070')
    integer(kind=c_int), parameter :: GL_TEXTURE_DEPTH                 = int(z'8071')
    integer(kind=c_int), parameter :: GL_TEXTURE_WRAP_R                = int(z'8072')
    integer(kind=c_int), parameter :: GL_MAX_3D_TEXTURE_SIZE           = int(z'8073')
    integer(kind=c_int), parameter :: GL_TEXTURE_BINDING_3D            = int(z'806A')
