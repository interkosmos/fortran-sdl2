...
module sdl2_keycode
    ...
    integer(kind=c_int), parameter :: SDLK_SPACE      = iachar(' ')
    integer(kind=c_int), parameter :: SDLK_EXCLAIM    = iachar('!')
    integer(kind=c_int), parameter :: SDLK_QUOTEDBL   = iachar('"')
    integer(kind=c_int), parameter :: SDLK_HASH       = iachar('#')
    integer(kind=c_int), parameter :: SDLK_PERCENT    = iachar('%')
    integer(kind=c_int), parameter :: SDLK_DOLLAR     = iachar('$')
    integer(kind=c_int), parameter :: SDLK_AMPERSAND  = iachar('&')
    integer(kind=c_int), parameter :: SDLK_QUOTE      = iachar("'")
    integer(kind=c_int), parameter :: SDLK_LEFTPAREN  = iachar('(')
    integer(kind=c_int), parameter :: SDLK_RIGHTPAREN = iachar(')')
    integer(kind=c_int), parameter :: SDLK_ASTERISK   = iachar('*')
    integer(kind=c_int), parameter :: SDLK_PLUS       = iachar('+')
    integer(kind=c_int), parameter :: SDLK_COMMA      = iachar(',')
    integer(kind=c_int), parameter :: SDLK_MINUS      = iachar('-')
    integer(kind=c_int), parameter :: SDLK_PERIOD     = iachar('.')
    integer(kind=c_int), parameter :: SDLK_SLASH      = iachar('/')
    integer(kind=c_int), parameter :: SDLK_0          = iachar('0')
    integer(kind=c_int), parameter :: SDLK_1          = iachar('1')
    integer(kind=c_int), parameter :: SDLK_2          = iachar('2')
    integer(kind=c_int), parameter :: SDLK_3          = iachar('3')
    integer(kind=c_int), parameter :: SDLK_4          = iachar('4')
    integer(kind=c_int), parameter :: SDLK_5          = iachar('5')
    integer(kind=c_int), parameter :: SDLK_6          = iachar('6')
    integer(kind=c_int), parameter :: SDLK_7          = iachar('7')
    integer(kind=c_int), parameter :: SDLK_8          = iachar('8')
    integer(kind=c_int), parameter :: SDLK_9          = iachar('9')
    integer(kind=c_int), parameter :: SDLK_COLON      = iachar(':')
    integer(kind=c_int), parameter :: SDLK_SEMICOLON  = iachar(';')
    integer(kind=c_int), parameter :: SDLK_LESS       = iachar('<')
    integer(kind=c_int), parameter :: SDLK_EQUALS     = iachar('=')
    integer(kind=c_int), parameter :: SDLK_GREATER    = iachar('>')
    integer(kind=c_int), parameter :: SDLK_QUESTION   = iachar('?')
    integer(kind=c_int), parameter :: SDLK_AT         = iachar('@')

    integer(kind=c_int), parameter :: SDLK_LEFTBRACKET  = iachar('[')
    integer(kind=c_int), parameter :: SDLK_BACKSLASH    = iachar('\')
    integer(kind=c_int), parameter :: SDLK_RIGHTBRACKET = iachar(']')
    integer(kind=c_int), parameter :: SDLK_CARET        = iachar('^')
    integer(kind=c_int), parameter :: SDLK_UNDERSCORE   = iachar('_')
    integer(kind=c_int), parameter :: SDLK_BACKQUOTE    = iachar('`')

    integer(kind=c_int), parameter :: SDLK_a = iachar('a')
    integer(kind=c_int), parameter :: SDLK_b = iachar('b')
    integer(kind=c_int), parameter :: SDLK_c = iachar('c')
    integer(kind=c_int), parameter :: SDLK_d = iachar('d')
    integer(kind=c_int), parameter :: SDLK_e = iachar('e')
    integer(kind=c_int), parameter :: SDLK_f = iachar('f')
    integer(kind=c_int), parameter :: SDLK_g = iachar('g')
    integer(kind=c_int), parameter :: SDLK_h = iachar('h')
    integer(kind=c_int), parameter :: SDLK_i = iachar('i')
    integer(kind=c_int), parameter :: SDLK_j = iachar('j')
    integer(kind=c_int), parameter :: SDLK_k = iachar('k')
    integer(kind=c_int), parameter :: SDLK_l = iachar('l')
    integer(kind=c_int), parameter :: SDLK_m = iachar('m')
    integer(kind=c_int), parameter :: SDLK_n = iachar('n')
    integer(kind=c_int), parameter :: SDLK_o = iachar('o')
    integer(kind=c_int), parameter :: SDLK_p = iachar('p')
    integer(kind=c_int), parameter :: SDLK_q = iachar('q')
    integer(kind=c_int), parameter :: SDLK_r = iachar('r')
    integer(kind=c_int), parameter :: SDLK_s = iachar('s')
    integer(kind=c_int), parameter :: SDLK_t = iachar('t')
    integer(kind=c_int), parameter :: SDLK_u = iachar('u')
    integer(kind=c_int), parameter :: SDLK_v = iachar('v')
    integer(kind=c_int), parameter :: SDLK_w = iachar('w')
    integer(kind=c_int), parameter :: SDLK_x = iachar('x')
    integer(kind=c_int), parameter :: SDLK_y = iachar('y')
    integer(kind=c_int), parameter :: SDLK_z = iachar('z')
